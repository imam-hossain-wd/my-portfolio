...
const Services = () => {
    return (
       ...
       <div className="grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-3  gap-20 w-full  lg:w-4/5 mx-auto">
        ...
        <div className="bg-black text-white p-10 rounded-lg  h-[340px] text-center  transition ease-in-out delay-150 bg-blue-500 hover:-translate-y-1 hover:scale-110 hover:bg-indigo-500 duration-300">
